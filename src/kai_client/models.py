...
class ChatRequest(BaseModel):
    ...
    is_headless: Optional[bool] = Field(default=None, alias="isHeadless")
...
class UsageResponse(BaseModel):
    ...
    messages_limit: int = Field(alias="messagesLimit")
...
class UserAgentSettings(BaseModel):
    """User-level agent settings including tool permissions."""
    ...
    custom_instructions: Optional[str] = Field(default=None, alias="customInstructions")
    tool_permissions: Optional[dict[str, str]] = Field(default=None, alias="toolPermissions")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
...
class Suggestion(BaseModel):
    """A contextual suggestion generated by the AI."""
...
class SuggestionsResponse(BaseModel):
    ...
    suggestion_session_id: str = Field(alias="suggestionSessionId")
